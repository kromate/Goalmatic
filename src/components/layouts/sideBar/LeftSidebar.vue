<template>
	<aside class="hidden md:flex min-h-screen flex-col justify-between max-w-[15rem] bg-transparent  fixed inset-y-0 z-50 w-[20%]  md:w-14 lg:w-[20%] ">
			...
			<div class="relative mt-[40px] flex flex-col lg:gap-2 gap-1">
				<div v-for="n in routes" :key="n.name" class="relative lg:px-4">
					<span class="w-full flex flex-col gap-4  px-2 lg:p-0">
						...
						<nuxt-link :to="n.route" class="flex items-center black use-hover " :style="{
