...
export default defineEventHandler(async (event) => {
  try {
    ...
    const systemPrompt = systemPrompts.SMART_MILESTONE.info
    const systemModel = systemPrompts.SMART_MILESTONE.model
    const systemSchema = systemPrompts.SMART_MILESTONE.schema
    ...
    // Error Handling
    // ===========================================================================
    console.error('Error in Generate Milestone API handler:', error)
